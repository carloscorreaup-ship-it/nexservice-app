  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 w-full max-w-xl shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        {/* Instructions banner */}
        <div className="bg-slate-800/60 border border-slate-700/80 rounded-2xl p-3.5 mb-4 text-xs text-slate-300 space-y-1.5">
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            rows={2}
            className="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-xs text-emerald-400 font-mono focus:outline-none focus:border-blue-500"
          />
        </div>
        ...
        {statusMessage && (
          <div className="p-2.5 mb-4 rounded-xl bg-blue-500/20 border border-blue-500/40 text-xs text-blue-200 text-center font-medium">
            {statusMessage}
          </div>
        )}
        ...
        <div className="flex items-center justify-between gap-3 pt-2">
          <button
            onClick={handleReset}
            className="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-400 text-xs font-semibold flex items-center gap-1.5 transition-all"
          >
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleSave}
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs font-bold shadow-lg shadow-blue-500/25 flex items-center gap-1.5 transition-all"
            >
